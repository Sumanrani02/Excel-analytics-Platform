...
import { BarChart3, Mail, Lock, ArrowRight, Shield, Users, TrendingUp } from 'lucide-react';
        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-6">
            ...
            <h2 className="text-4xl font-bold text-gray-900 leading-tight">
              ...
              <span className="bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent"> actionable insights</span>
            </h2>
            
            <p className="text-lg text-gray-600 leading-relaxed">
              Join thousands of professionals who trust Excel Analytics to streamline their data analysis workflow and make better business decisions.
            </p>
          </div>
